...
public class Output {
    ...
    public static long getCurrentTime(Spot spot) {
        return System.currentTimeMillis();
    }

	public static void printExecutionTime(String stageName, long startTime) {
        long end = System.currentTimeMillis();
        System.out.println("StageName: " + stageName + ",  ExecutionTime: " + (end - startTime) + "ms");
    }
}
